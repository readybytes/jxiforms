...
<div class="row-fluid">
	<div class="span12">
		...
		<div class="span7 dashboard-icon-panel jxif-left-padding01">
			<div class="span10 jxif-padding01 jxif-action-heading jxif-fontsize15 margin-top2 jxif-text-colorgray"><?php echo Rb_Text::_('COM_UGLYFORMS_SUBMENU_ACTION');?></div>
		...
		<?php
			...
			<div class="span12 dashboard-icon-panel">
				<iframe class="span12 jxif-padding02 jxif-border00" height="325px;" src="http://pub.joomlaxi.com/broadcast/broadcast.html?<?php echo $suffix?>"></iframe>
				<div class="span12">
