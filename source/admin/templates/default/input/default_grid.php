	...
	<table class="table table-striped">
		...
		<!-- TABLE HEADER START -->
			<tr>
				...
				<th class="default-grid-sno"><?php echo JXiFormsHtml::_('grid.sort', "COM_JXIFORMS_INPUT_GRID_INPUT_ID", 'input_id', $filter_order_Dir, $filter_order);?></th>
				...
				<th class="hidden-phone"><?php echo Rb_Text::_('COM_JXIFORMS_INPUT_GRID_REDIRECTURL');?></th>
		...
		<!-- TABLE BODY START -->
			...
			foreach ($records as $record):?>
				<tr class="<?php echo "row".$count%2; ?>">								
					<th class="default-grid-chkbox"><?php echo JXiFormsHtml::_('grid.id', $count, $record->{$record_key} ); ?></th>				
					...
					<td class="hidden-phone"><?php echo $record->redirect_url;?></td>
