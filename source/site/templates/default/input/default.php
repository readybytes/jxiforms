...
<?php if ($input->getId()):?>
	...
	<div class="row-fluid">
		<?php if($input->isPublished()){?>
			 ...
			 <form action="<?php echo Rb_Route::_('index.php?option=com_uglyforms&view=input&task=submit&input_id='.$input->getId());?>" method="post" name="site<?php echo $this->getName(); ?>Form" class="form-horizontal rb-validate-form" enctype="multipart/form-data" >
