...
class UglyformsModelInputaction extends UglyformsModel
{
	...
	{
		if(!$actionId){
			throw new Exception(Rb_Text::sprintf('COM_UGLYFORMS_EXCEPTION_INVALID_ACTION_ID', $actionId));
		}
...
class UglyformsModelformFormaction extends UglyformsModelform { }
