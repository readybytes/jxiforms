...
class UglyformsHtmlActiontypes
{
	function edit($name, $value, $attr=null, $ignore=array())
	{
		$actions = UglyformsHelperAction::getActions();
		
		$options = array();
		if(isset($attr['none']))
			$options[] = UglyformsHtml::_('select.option', '', Rb_Text::_('COM_UGLYFORMS_ACTION_SELECT_ACTION_TYPE'));
