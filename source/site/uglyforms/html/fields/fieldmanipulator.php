...
class UglyformsFormFieldFieldmanipulator extends JFormFieldList
{
	...
	function getInput()
	{
		...
		return UglyformsHtml::_('uglyformshtml.fieldmanipulator.edit',$options, $this->value, $fields, ''.$this->name, $class, $this->group.$this->fieldname ,$this->group);
	}
